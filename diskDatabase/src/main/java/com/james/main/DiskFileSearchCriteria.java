...
public class DiskFileSearchCriteria {
	...
	public String toString() {
		return "name: " + name + " " + " path: " + path + " sizeHigh: "
				+ sizeHigh + " sizeLow: " + sizeLow + " type: " + type;
	}

	public DiskFileSearchCriteria(String name, String type, String path,
			Long sizeLow, Long sizeHigh) {
		this.name = name;
		this.type = type;
		this.path = path;
