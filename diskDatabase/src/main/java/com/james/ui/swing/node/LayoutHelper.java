...
public class LayoutHelper {
	...
	public JComponent layoutButton(JButton button, JComponent predecessor,
			JPanel container) {
		...
		if (predecessor == null) {
			...
			layout.putConstraint(SpringLayout.NORTH, button, 5,
					SpringLayout.SOUTH, predecessor);
	...
	public JComponent layoutField(JLabel label, JTextField field,
			JComponent predecessor, JPanel container) {
		...
		if (predecessor == null) {
			...
			// Layout field
			layout.putConstraint(SpringLayout.WEST, field, 5,
					SpringLayout.EAST, label);
			layout.putConstraint(SpringLayout.NORTH, field, 5,
					SpringLayout.NORTH, container);
