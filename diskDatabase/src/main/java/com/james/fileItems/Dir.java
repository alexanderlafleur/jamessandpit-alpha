...
public class Dir {
    ...
    public Dir(long id, String name, Dir parent) {
        this(id, name, parent, new HashSet(), new HashSet(), new HashSet());
    }

    public Dir(long id, String name, Dir parent, Set<Dir> dirs, Set<DiskFile> files, Set<MP3> mp3s) {
        this.id = id;
        this.name = name;
        this.parent = parent;
        this.dirs = dirs;
