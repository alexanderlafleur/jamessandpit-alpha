...
public class MP3SearchCriteria {
	...
	public MP3SearchCriteria(String name, String type, Long sizeLow,
			Long sizeHigh, String album, String artist) {
		this.name = name;
		this.type = type;
	...
	public String toString() {
		...
		sb.append("MP3 Criteria: " + getId() + " " + getType() + " "
				+ getName() + " " + getSizeLow() + " " + getSizeHigh() + ""
