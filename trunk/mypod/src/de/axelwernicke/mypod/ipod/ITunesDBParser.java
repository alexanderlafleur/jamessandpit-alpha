...
public class ITunesDBParser {
     ...
     */
    private static String ITUNES_DB_PATH = "iPod_Control" + File.separator + "iTunes" + File.separator + "iTunesDB";
     ...
     * 
     * @param _db
     *            database to create a parser for
     */
    ...
    ITunesDB load() {
        ...
        try {
            ...
            FileInputStream fis = new FileInputStream(myPod.getBackend().getPreferences().getIPodPath() + File.separator + ITUNES_DB_PATH);
     ...
     *            ITunesDB to save
     */
    boolean save(ITunesDB database) {
        ...
        try {
            ...
            while (fis.read(tag) != -1) {
                ...
                // ----------- mhsd --------------
                    ...
                    // there are usually two list holder records in a database,
                ...
                // ----------- mhit --------------
                    ...
                    // mhit records always belong to the song list, so add it
                    // there and mark as recent
                ...
                // ----------- mhod --------------
                    ...
                    // mhod records may belong to a song, or to an playlist
                    // entry, or to an
                    ...
                    if (recentPlaylistIndexItem != null) {
                        ...
                        // set Content changes the content size - we don't want
                        // this ...
                ...
                // ----------- mhlp --------------
                    ...
                    // since there is only one playlist header, simply add it to
                    // the data base
                ...
                // ----------- mhip --------------
                    ...
                    // mhip records always belong to a playlist, so append to
                    // the most recently added playlist
     ...
     * 
     * @param fis
     *            stream to parse the record from
     ...
     * 
     * @param fos
     *            stream to write the db record to
     */
    ...
    private static ITunesDBPlaylistHeader parsePlaylistHeader(InputStream fis) {
        ...
        try {
            ...
            fis.read(dword);
            // done implicitly playlistHeader.playlistCount =
            // littleEndianToInt(dword);
        ...
        try {
            ...
            for (int i = 0; i < songCnt; i++) {
                ...
                if (tmp instanceof de.axelwernicke.mypod.ipod.ITunesDBPlaylistIndexItem) {
                    ...
                    // encode content item
                    this.encodeContentItem(fos, (ITunesDBContentItem) tmp);
                }
            }
    ...
    int calculateRecordSize(Object obj) {
        ...
        try {
            ...
            // axelwe 030705 if(
            // obj.getClass().getName().equals("de.axelwernicke.mypod.ipod.ITunesDB")
            // )
            if (obj instanceof de.axelwernicke.mypod.ipod.ITunesDB) {
                this.encodeDbRecord(bau);
                this.encodeListHolder(bau, db.getSonglistHolder());
                this.encodeSonglistHeader(bau);
                this.encodeListHolder(bau, db.getPlaylistHolder());
                this.encodePlaylistHeader(bau);
            }
            // axelwe 030705 else if(
            // obj.getClass().getName().equals("de.axelwernicke.mypod.ipod.ITunesDBContentItem")
            // )
            else if (obj instanceof de.axelwernicke.mypod.ipod.ITunesDBContentItem) {
                this.encodeContentItem(bau, (ITunesDBContentItem) obj);
            }
            // axelwe 030705 else if(
            // obj.getClass().getName().equals("de.axelwernicke.mypod.ipod.ITunesDBListHolder")
            // )
            else if (obj instanceof de.axelwernicke.mypod.ipod.ITunesDBListHolder) {
                this.encodeListHolder(bau, (ITunesDBListHolder) obj);
                ...
                this.encodePlaylistIndexItem(bau, (ITunesDBPlaylistIndexItem) obj);
                ...
                this.encodeSongItem(bau, (ITunesDBSongItem) obj);
     ...
     * <PRE>
     * 
     * mac date is seconds since 01/01/1904 java date is milliseconds since
     * 01/01/1970
     * 
     * </PRE>
     * 
