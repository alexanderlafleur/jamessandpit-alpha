...
public class ITunesDBContentItem {
    ...
    /**
     * item size in bytes mysteriously, but tag size is in hex, but only for
     * this item typ :?
     */
    ...
    public String toString() {
        return new StringBuffer("[tag size] ").append(tagSize).append('\t').append("[recordSize] ").append(recordSize).append('\t').append(
                "[contentTyp] ").append(contentTyp).append('\t').append("[unknown5] ").append(unknown5).append('\t').append("[unknown6] ").append(
                unknown6).append('\t').append("[listPosition] ").append(listPosition).append('\t').append("[contentSize] ").append(contentSize)
                .append('\t').append("[unknown9] ").append(unknown9).append('\t').append("[unknown10] ").append(unknown10).append('\t').append(
                        "[content] ").append(getContentAsString()).toString();
    }
