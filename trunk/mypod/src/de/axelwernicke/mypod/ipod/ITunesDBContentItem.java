...
public class ITunesDBContentItem {
     ...
     * 
     * @param contentTyp
     *            New value of property contentTyp.
     */
     ...
     * 
     * @param listPosition
     *            New value of property listPosition.
     */
     ...
     * 
     * @param contentSize
     *            New value of property contentSize.
     */
     ...
     * 
     * @param unknown9
     *            New value of property unknown9.
     */
     ...
     * 
     * @param unknown10
     *            New value of property unknown10.
     */
    ...
    public String toString() {
        return new StringBuffer("[tag size] ").append(tagSize).append('\t').append("[recordSize] ").append(recordSize).append('\t').append("[contentTyp] ").append(contentTyp)
                .append('\t').append("[unknown5] ").append(unknown5).append('\t').append("[unknown6] ").append(unknown6).append('\t').append("[listPosition] ")
                .append(listPosition).append('\t').append("[contentSize] ").append(contentSize).append('\t').append("[unknown9] ").append(unknown9).append('\t').append(
                        "[unknown10] ").append(unknown10).append('\t').append("[content] ").append(getContentAsString()).toString();
    }
