...
public class Preferences implements java.lang.Cloneable, java.io.Serializable {
    ...
    /**
     * defines the default preferences for each column of a list view model. values are: <BR> - visibility (1 means show this column in list view) <BR> - width (width of column)
