...
public class SingleLineFormatter extends java.util.logging.Formatter {
    ...
    public String format(LogRecord record) {
        return new StringBuffer().append(dateFormat.format(new Date(record.getMillis()))).append(" ").append(record.getLevel()).append(" ").append(
                record.getSourceClassName()).append(".").append(record.getSourceMethodName()).append('\t').append(record.getMessage()).append('\n')
                .toString();
    }
