...
public class ClipsTableUtils {
    ...
    public static final String columnNames[] = { GuiUtils.getStringLocalized("resource/language", "album"),
            GuiUtils.getStringLocalized("resource/language", "artist"), GuiUtils.getStringLocalized("resource/language", "artistwebpage"),
            GuiUtils.getStringLocalized("resource/language", "audioFileWebpage"),
            ...
            GuiUtils.getStringLocalized("resource/language", "encodedBy"),
            GuiUtils.getStringLocalized("resource/language", "encryptionMethodRegistration"),
            ...
            GuiUtils.getStringLocalized("resource/language", "internetRadioStationName"),
            GuiUtils.getStringLocalized("resource/language", "internetRadioStationOwner"),
            ...
            GuiUtils.getStringLocalized("resource/language", "recommendedBufferSize"),
            GuiUtils.getStringLocalized("resource/language", "recordingDate"), GuiUtils.getStringLocalized("resource/language", "relativeVolume"),
            GuiUtils.getStringLocalized("resource/language", "remixer"), GuiUtils.getStringLocalized("resource/language", "reverb"),
            GuiUtils.getStringLocalized("resource/language", "sampleRate"), GuiUtils.getStringLocalized("resource/language", "subtitle"),
            GuiUtils.getStringLocalized("resource/language", "synchronizedLyrics"),
            GuiUtils.getStringLocalized("resource/language", "synchronizedTempoCodes"),
            GuiUtils.getStringLocalized("resource/language", "termsOfUse"), GuiUtils.getStringLocalized("resource/language", "time"),
            GuiUtils.getStringLocalized("resource/language", "title"), GuiUtils.getStringLocalized("resource/language", "track"),
            GuiUtils.getStringLocalized("resource/language", "uniqueFileIdentifier"),
            ...
            GuiUtils.getStringLocalized("resource/language", "useSynchronization"),
            GuiUtils.getStringLocalized("resource/language", "userdefinedText"), GuiUtils.getStringLocalized("resource/language", "userdefinedURL"),
            GuiUtils.getStringLocalized("resource/language", "writeID3"), GuiUtils.getStringLocalized("resource/language", "writeID3v2"),
            GuiUtils.getStringLocalized("resource/language", "year"), };
}
