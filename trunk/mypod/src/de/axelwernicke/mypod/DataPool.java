...
public class DataPool {
    ...
    /**
     * Adds meta data object to the data pool. A new (unique) oid is generated.
    ...
    /**
     * Removes a clip from the data pool. data and filename cache are updated.
    ...
    /**
     * Validates the data object and removes invalid entries Checks if data is
     * null or not, if key is null and if value is null
     */
     ...
     * 
     * @param clips
     *            to get titles from. If clips is null, all clips in the data
     *            pool are evaluated.
     * @param sort
     *            the titles
     ...
     * 
     * @param clips
     *            to get artists from. If clips is null, all clips in the data
     *            pool are evaluated.
     * @param sort
     *            the artists
     ...
     * 
     * @param clips
     *            to get bands from. If clips is null, all clips in the data
     *            pool are evaluated.
     * @param sort
     *            the bands
     ...
     * 
     * @param clips
     *            to get comments from. If clips is null, all clips in the data
     *            pool are evaluated.
     * @param sort
     *            the comments
     ...
     * 
     * @param clips
     *            to get composers from. If clips is null, all clips in the data
     *            pool are evaluated.
     * @param sort
     *            the composers
     ...
     * 
     * @param clips
     *            to get content group set values from. If clips is null, all
     *            clips in the data pool are evaluated.
     * @param sort
     ...
     * 
     * @param clips
     *            to get copyright text values from. If clips is null, all clips
     *            in the data pool are evaluated.
     * @param sort
     ...
     * 
     * @param clips
     *            to get copyright webpage values from. If clips is null, all
     *            clips in the data pool are evaluated.
     * @param sort
     ...
     * 
     * @param clips
     *            to get encoded by values from. If clips is null, all clips in
     *            the data pool are evaluated.
     * @param sort
     ...
     * 
     * @param clips
     *            to get genres from. If clips is null, all clips in the data
     *            pool are evaluated.
     * @param sort
     *            the genres
     ...
     * 
     * @param clips
     *            to get lyricists from. If clips is null, all clips in the data
     *            pool are evaluated.
     * @param sort
     *            the lyricists
     ...
     * 
     * @param clips
     *            to get original artist values from. If clips is null, all
     *            clips in the data pool are evaluated.
     * @param sort
     ...
     * 
     * @param clips
     *            to get playcounter from. If clips is null, all clips in the
     *            data pool are evaluated.
     * @param sort
     ...
     * 
     * @param clips
     *            to get original lyricist values from. If clips is null, all
     *            clips in the data pool are evaluated.
     * @param sort
     ...
     * 
     * @param clips
     *            to get original title values from. If clips is null, all clips
     *            in the data pool are evaluated.
     * @param sort
     ...
     * 
     * @param clips
     *            to get original year values from. If clips is null, all clips
     *            in the data pool are evaluated.
     * @param sort
     ...
     * 
     * @param clips
     *            to get publisher values from. If clips is null, all clips in
     *            the data pool are evaluated.
     * @param sort
     ...
     * 
     * @param clips
     *            to get publisher webpage values from. If clips is null, all
     *            clips in the data pool are evaluated.
     * @param sort
     ...
     * 
     * @param clips
     *            to get track values from. If clips is null, all clips in the
     *            data pool are evaluated.
     * @param sort
     *            the track values
     ...
     * 
     * @param clips
     *            to get years from. If clips is null, all clips in the data
     *            pool are evaluated.
     * @param sort
     *            the years
