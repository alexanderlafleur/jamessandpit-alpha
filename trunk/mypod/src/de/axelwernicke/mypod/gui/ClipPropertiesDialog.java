...
public class ClipPropertiesDialog extends javax.swing.JDialog {
     ...
     * 
     * @param confirmed
     *            New value of property confirmed.
     */
     ...
     * 
     * @return mp3 meta data object containing only changed values. Other values
     *         are null or -1
     */
    MP3Meta getChangedValues() {
        ...
        /* ----------------- STRING VALUES -------------------------- */
        meta.setAlbum(prepareStringValue(dummyValue, this.albumComboBox.getSelectedItem()));
        meta.setArtist(prepareStringValue(dummyValue, this.artistComboBox.getSelectedItem()));
        meta.setBand(prepareStringValue(dummyValue, this.bandComboBox.getSelectedItem()));
        meta.setBpm(prepareStringValue(dummyValue, this.bpmComboBox.getSelectedItem()));
        meta.setCdIdentifier(prepareStringValue(dummyValue, this.cdIdentifierComboBox.getSelectedItem()));
        meta.setComment(prepareStringValue(dummyValue, this.commentComboBox.getSelectedItem()));
        meta.setComposer(prepareStringValue(dummyValue, this.composerComboBox.getSelectedItem()));
        meta.setContentGroupset(prepareStringValue(dummyValue, this.contentGroupSetComboBox.getSelectedItem()));
        meta.setCopyrightText(prepareStringValue(dummyValue, this.copyrightTextComboBox.getSelectedItem()));
        meta.setCopyrightWebpage(prepareStringValue(dummyValue, this.copyrightWebpageComboBox.getSelectedItem()));
        meta.setEncodedBy(prepareStringValue(dummyValue, this.encodedByComboBox.getSelectedItem()));
        meta.setGenre(prepareStringValue(dummyValue, this.genreComboBox.getSelectedItem()));
        meta.setIsrc(prepareStringValue(dummyValue, this.isrcComboBox.getSelectedItem()));
        meta.setLanguage(prepareStringValue(dummyValue, this.languageComboBox.getSelectedItem()));
        meta.setLyricist(prepareStringValue(dummyValue, this.lyricistComboBox.getSelectedItem()));
        meta.setOriginalArtist(prepareStringValue(dummyValue, this.originalArtistComboBox.getSelectedItem()));
        meta.setOriginalLyricist(prepareStringValue(dummyValue, this.originalLyricistComboBox.getSelectedItem()));
        meta.setOriginalTitle(prepareStringValue(dummyValue, this.originalTitleComboBox.getSelectedItem()));
        meta.setOriginalYear(prepareStringValue(dummyValue, this.originalYearComboBox.getSelectedItem()));
        meta.setPlayCounter(prepareStringValue(dummyValue, this.playcounterComboBox.getSelectedItem()));
        meta.setPublisher(prepareStringValue(dummyValue, this.publisherComboBox.getSelectedItem()));
        meta.setPublishersWebpage(prepareStringValue(dummyValue, this.publisherWebpageComboBox.getSelectedItem()));
        meta.setTitle(prepareStringValue(dummyValue, this.titleComboBox.getSelectedItem()));
        meta.setPublisher(prepareStringValue(dummyValue, this.publisherComboBox.getSelectedItem()));
         ...
         * -----------------------
         */
        meta.setTrack(prepareIntValue(dummyValue, this.trackComboBox.getSelectedItem()));
        meta.setYear(prepareIntValue(dummyValue, this.yearComboBox.getSelectedItem()));
    ...
    /**
     * Prepares the selected item in the dialog to be an string in the meta
     * object of changed values.
     * 
     * @param dummyValue
     *            value to be explicitly not set in the result
     * @param value
     *            to prepare
    ...
    /**
     * Prepares the selected item in the dialog to be an int in the meta object
     * of changed values.
     * 
     * @param dummyValue
     *            value to be explicitly not set in the result
     ...
     *            to read values from
     */
    void setValues(DataPool dataPool, Vector clips) {
        String defaultValue = GuiUtils.getStringLocalized("leaveAsIs");

        /* ------------------------- STRING VALUES -------------------- */
        this.albumComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllAlbumValues(clips, true)));
        this.artistComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllArtistValues(clips, true)));
        this.bpmComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllBpmValues(clips, true)));
        this.bandComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllBandValues(clips, true)));
        this.cdIdentifierComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllCdIdentifierValues(clips, true)));
        this.commentComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllCommentValues(clips, true)));
        this.composerComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllComposerValues(clips, true)));
        this.contentGroupSetComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllContentGroupSetValues(clips, true)));
        this.copyrightTextComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllCopyrightTextValues(clips, true)));
        this.copyrightWebpageComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllCopyrightWebpageValues(clips, true)));
        this.encodedByComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllEncodedByValues(clips, true)));
        this.genreComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllGenreValues(clips, true)));
        this.isrcComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllIsrcValues(clips, true)));
        this.languageComboBox.setModel(prepareComboBoxModel(defaultValue, LanguageUtils.getAllLanguageNames()));
        this.lyricistComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllLyricistValues(clips, true)));
        this.originalArtistComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllOriginalArtistValues(clips, true)));
        this.originalTitleComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllOriginalTitleValues(clips, true)));
        this.originalLyricistComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllOriginalLyricistValues(clips, true)));
        this.originalYearComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllOriginalYearValues(clips, true)));
        this.playcounterComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllPlaycounterValues(clips, true)));
        this.publisherComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllPublisherValues(clips, true)));
        this.publisherWebpageComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllPublisherWebpageValues(clips, true)));
        this.titleComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllTitleValues(clips, true)));

        /* ------------------------- STRING VALUES -------------------- */
        this.trackComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllTrackValues(clips, true)));
        this.yearComboBox.setModel(prepareComboBoxModel(defaultValue, dataPool.getAllYearValues(clips, true)));
    }

    /**
     */
    private DefaultComboBoxModel prepareComboBoxModel(String defaultValue, Vector values) {
