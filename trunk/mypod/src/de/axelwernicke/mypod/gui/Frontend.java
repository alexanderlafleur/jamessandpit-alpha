...
/**
 * This class contains all the gui stuff for the main window. Please note, that
 * most of the event & action handling is done in de.axelwernicke.mypod.myPod.
 * 
...
public class Frontend extends javax.swing.JFrame {
    ...
    /**
     * Handle the menu selected event for the clip menu. Enables / Disables clip
     * menu items before menu is shown
     * 
     * @param evt
     */
    ...
    /**
     * Handle the menu selected event for the playlist menu. Enables / Disables
     * playlist menu items before menu is shown
     * 
     * @param evt
     */
    ...
    /**
     * Gets the full list view. Since all views are sharing one listView object,
     * there will be always the same object returned...
     * 
