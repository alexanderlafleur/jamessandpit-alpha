...
public class ListView extends javax.swing.JTable {
    ...
    /**
     * gets tracks from ListView for DnD - drag from list view. oids are
     * determined from filename via data pool
     * 
    ...
    /**
     * sets clips to the list view. Actually this method is called if a clip is
     * dropped to the list view. Please note, that this method is not
     * implemented yet.
     * 
     * @param oids
