...
public class SelectionPanel extends javax.swing.JPanel {
    ...
    /**
     * Handles value changed events for the selected list. Most important it
     * makes sure that selected values are displayed. The list is scrolled if
     * neccessary.
     */
    ...
    public Vector getSelection() {
        ...
        for (Enumeration e = selectedListModel.elements(); e.hasMoreElements();) {
    ...
    /**
     * Adds some objects to the selection list and removes them from the
     * unselected list if they are in there
     * 
     * @param selection
     */
    ...
    // /** Adds an objects to the selection list and removes it from the
    // unselected list if it is in there
    // * @param selection object to select
    // */
    // void select(Object selection)
    // {
    // move( this.getUnselectedListModel(), this.getSelectedListModel(),
    // selection );
    // }
     ...
     * 
     * @param src
     *            list model - all its content is moved
     * @param dest
     *            list model
     */
     ...
     *            list model
     * @param obj
     *            array of objects to move from src to dest
     */
     ...
     *            list model
     * @param obj
     *            object to move from src to dest
     */
    private void move(DefaultListModel src, DefaultListModel dest, Object obj) {
        dest.addElement(obj);
        if (src.contains(obj)) {
    ...
    private void sort(DefaultListModel listModel) {
        ...
        // sort - sometimes this throws an exception :( - greetings to SUN - I
