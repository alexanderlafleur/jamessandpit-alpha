// ProgressDialog
// $Id: ProgressDialog.java,v 1.11 2003/06/21 18:39:07 axelwernicke Exp $
//
...
/**
 * ProgressDialog provides a progress bar within a dialog window and a cancel
...
public class ProgressDialog extends javax.swing.JDialog {
     ...
     * 
     * @param worker
     *            thread the dialog is attached to
     * @param parent
     *            frame for the dialog
     * @param modal
     *            create dialog (a-) synchronously
     */
    public ProgressDialog(SwingWorker worker, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.worker = worker;
        initComponents();
    }
    ...
    private void initComponents()// GEN-BEGIN:initComponents
    {
        ...
        setTitle(GuiUtils.getStringLocalized("resource/language", "progress..."));
