...
public class GuiUtils {
     ...
     * Since all methods in here are static you should never be in need to call it...
     */
    private GuiUtils() {
    }
    ...
    /**
     * Gets the selected clips <BR>- get current clips table view <BR>- get oids for selected clips from the view
     * 
     * @param frontend
    ...
    /**
     * Creates and shows the playlist property dialog. <BR>- create property dialog <BR>- set tree model <BR>- set data from playlist to the dialog <BR>- show dialog
     * 
     * @param playlist
    ...
    public static boolean showPlaylistPropertyDialog(Playlist playlist, Frontend frontend, Backend backend) {
        ...
        // set tree
        DefaultTreeModel tree = playlist.isAutoplaylist() ? new DefaultTreeModel(GuiUtils.getAutoPlaylistPropertyTreeModel()) : new DefaultTreeModel(GuiUtils
    ...
    /**
     * Prepares and shows preferences dialog and evaulates result. <BR>- create preferences dialog <BR>- set tree model <BR>- set data from prefs to the dialog <BR>- show
     * dialog <BR>- copy data from dialog to prefs
     * 
     * @return true, if the dialog was confirmed by the user
     * @param prefs
     *            for myPod
    ...
    public static void updateStatusLine(Frontend frontend) {
        ...
        if (playlist != null) {
            ...
            ? oids.size() + " of " + playlist.getTotalClips() + " " + GuiUtils.getStringLocalized("clips") + " | " + formatTime(myPod.getBackend().getTotalTime(oids)) + " | "
                    + formatFilesizeMB(myPod.getBackend().getTotalFilesize(oids), 2) + " "
    ...
    public static Rectangle calcCenteredBounds(Rectangle mainFrame, Rectangle dialog) {
        Rectangle rect;
        rect = new Rectangle((int) (mainFrame.getX() + (mainFrame.getWidth() / 2) - (dialog.getWidth() / 2)), (int) (mainFrame.getY() + (mainFrame.getHeight() / 2) - (dialog
                .getHeight() / 2)), (int) dialog.getWidth(), (int) dialog.getHeight());
        return rect;
    }
