...
/**
 * Column model for myPods list view. This class extends the
 * DefaultTableColumnModel class. Functionality to make sorting of columns
 * persistent, as well as cell renderers are added.
 * 
...
public class ClipsTableColumnModel extends javax.swing.table.DefaultTableColumnModel {
    ...
    /**
     * Adds a column to a column model. The column is added if, and only if, it
     * is enabled in the preferences object. Width of the column is set from the
     * preferences too.
     * 
     * @param column
    ...
    public void storeColumnPreferences() {
        ...
        for (int col = 0; col < columnCount; col++) {
            ...
            if (logger.isLoggable(Level.FINER)) {
                logger.finer("stored column move for model column:" + getColumn(col).getModelIndex() + " from "
                        + colInfo[getColumn(col).getModelIndex()][2] + " to " + col);
            }
