...
/**
 * This is the main class of myPod. It contains all the code for starting and
 * shutting down myPod, as well as the gui logic (actions etc.). It's kind of
 * glue between application logic and gui.
 * 
...
public class myPod {
    ...
    /**
     * has accelerator, small icon and text // TODO: we should clean them up,
     * but they are contained in the frontend.jave...
     */
    ...
    /**
     * myPods main class - never call this method directly. <BR>- show splash
     * screen <BR>- check jvm version <BR>- create backend object <BR>-
     * create frontend <BR>- update all auto playlists <BR>- hide splas screen
    ...
    public static Playlist getPlaylist(int index) {
        return (Playlist) backend.getPlaylist(index);
    }

    /**
     * Gets the index of the currently selected playlist from the list of
     * playlists
     * 
    ...
    /**
     * Sets a column listener to a JTable object. This method is used to add
     * enable sorting to a table.
     * 
     * @param clipsTableView
     *            to set the column listener for
     */
        ...
        MouseAdapter listMouseListener = new MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                ...
                if (e.getClickCount() == 1 && column != -1) {
                    ...
                    // seems we loose our ColumnModel changes here, so store and
     ...
     * 
     * @param columnCode
     *            of the column to create a model for
     * @param playlistIndex
     ...
     */
    public static Vector getPlaylistMenuItems() {
        ...
        // create a menu item for each existing playlist, except the selected
        // one
     ...
     * 
     * @param playlist
     *            to update the table model with
     */
    public static void updateClipsTableModel(Playlist playlist) {
        if (frontend != null && frontend.getClipsTableView() != null) {
            ...
            // we'about to change the model, so lets save the sorting of the
            // table columns
            Vector sortingColumns = new Vector(101);
            if (colModel != null) {
