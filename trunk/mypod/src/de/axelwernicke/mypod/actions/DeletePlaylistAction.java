...
public class DeletePlaylistAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            if (index >= 0) {
                int result = JOptionPane.showConfirmDialog(null, GuiUtils.getStringLocalized("doYouWantToDeleteThisPlaylist"), GuiUtils
                        .getStringLocalized("confirmRemovePlaylist"), JOptionPane.YES_NO_OPTION);
