 ...
 * Action to change directory structure and filenames according to some meta
 * data of the files. <br>
            ...
            public Object construct() {
                ...
                try {
                    ...
                    if (prefsDialog.isConfirmed()) {
                        ...
                        // reorganize clips
                        myPod.getBackend().reorganizeClips(progressDialog, prefsDialog.baseDirTextField.getText(),
                                prefsDialog.dirStructComboBox.getSelectedIndex(), prefsDialog.filenameStructComboBox.getSelectedIndex(),
                                prefsDialog.isRemoveEmptyDirectories());
                    }
                } catch (Exception e) {
