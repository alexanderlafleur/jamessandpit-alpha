                ...
                try {
                    ...
                    do {
                        ...
                        if (!iPodFound) {
                            ...
                            result = JOptionPane.showOptionDialog(null, GuiUtils.getStringLocalized("makeIPodAvailableAsDrive"), GuiUtils.getStringLocalized("iPodNotAvailable"),
                    ...
                    if (iPodFound) {
                        ...
                        if (spaceLeft < 0) {
                            JOptionPane.showMessageDialog(null, GuiUtils.getStringLocalized("notEnoughSpaceOnIPod") + " ( " + GuiUtils.formatFilesize(spaceLeft) + " )", GuiUtils
                                    .getStringLocalized("couldNotSynchronize"), JOptionPane.ERROR_MESSAGE);
                        }
                    } // iPod found
                } catch (Exception e) {
