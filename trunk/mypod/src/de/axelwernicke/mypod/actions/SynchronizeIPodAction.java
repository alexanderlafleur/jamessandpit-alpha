...
/**
 * Synchronize iPod Action class<br>
 * <br>
            ...
            public Object construct() {
                ...
                try {
                    ...
                    if (iPodFound) {
                        ...
                        if (spaceLeft < 0) {
                            JOptionPane.showMessageDialog(null, GuiUtils.getStringLocalized("notEnoughSpaceOnIPod") + " ( "
                                    + GuiUtils.formatFilesize(spaceLeft) + " )", GuiUtils.getStringLocalized("couldNotSynchronize"),
