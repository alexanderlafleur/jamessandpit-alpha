...
/**
 * Clips Property Action class. determine selected clip(s) determine selected playlist show dialog to confirm action remove clips from the playlist
 */
                ...
                try {
                    ...
                    if (oids.size() > 0) {
                        ...
                        if (meta != null) {
                            ...
                            // lower thread priority, this helps to end the
                            // application in the case the update hangs
                            ...
                            // tell the model about added items, this helps even
                            // for non auto-playlists
                            myPod.updateModels();
                        }
                    }
                } catch (Exception e) {
