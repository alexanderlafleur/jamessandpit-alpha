...
/**
 * Remove Clips Action class. removes a clip from the selected playlist. No
 * clips are harmed by this action :) determine selected clip(s) determine
 * selected playlist show dialog to confirm action remove clips from the
 * playlist
 */
