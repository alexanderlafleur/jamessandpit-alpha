        ...
        SwingWorker worker = new SwingWorker() {
            ...
            public Object construct() {
                ...
                try {
                    ...
                    Vector missingClips = myPod.getBackend().scanForMissingMediaFiles(progressDialog);

                    if (missingClips != null && !missingClips.isEmpty()) {
                        // get user confirmation for deletion
                        int result = JOptionPane.showConfirmDialog(progressDialog, GuiUtils.getStringLocalized("missingMediaFilesFound1") + " " + missingClips.size() + " "
                                + GuiUtils.getStringLocalized("missingMediaFilesFound2") + '\n' + GuiUtils.getStringLocalized("doYouWantToRelocateClips"), GuiUtils
                                .getStringLocalized("confirmRelocateClips"), JOptionPane.YES_NO_OPTION);
