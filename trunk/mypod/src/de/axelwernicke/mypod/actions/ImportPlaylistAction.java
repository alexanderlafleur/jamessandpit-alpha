...
public class ImportPlaylistAction extends AbstractAction {
    ...
    public ImportPlaylistAction(int mode) {
        ...
        // KeyEvent.VK_P, InputEvent.SHIFT_MASK | InputEvent.CTRL_MASK));
            ...
            if (fcResult == JFileChooser.APPROVE_OPTION) {
                ...
                for (int i = 0; i < files.length; i++) {
                    ...
                    if (existingPlaylist != null) {
                        ...
                        Object[] options = { GuiUtils.getStringLocalized("replace"), GuiUtils.getStringLocalized("add") };
                        int result = JOptionPane.showOptionDialog(null, GuiUtils.getStringLocalized("existingPlaylistfound"), GuiUtils
                                .getStringLocalized("importingPlaylist"), JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options,
                                options[1]);
