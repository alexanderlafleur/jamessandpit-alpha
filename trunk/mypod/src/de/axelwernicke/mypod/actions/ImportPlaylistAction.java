        ...
        try {
            ...
            if (fcResult == JFileChooser.APPROVE_OPTION) {
                ...
                for (File element : files) {
                    // import
                    playlist = myPod.getBackend().loadPlaylistM3U(element);
                    ...
                    if (existingPlaylist != null) {
                        ...
                        int result = JOptionPane.showOptionDialog(null, GuiUtils.getStringLocalized("existingPlaylistfound"), GuiUtils.getStringLocalized("importingPlaylist"),
