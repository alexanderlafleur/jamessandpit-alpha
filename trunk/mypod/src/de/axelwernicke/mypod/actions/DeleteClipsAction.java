...
/**
 * Delete Clips Action class. This action removes a clip from myPod and deletes the media file
 */
public class DeleteClipsAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            if (oids.size() > 0) {
                int result = JOptionPane.showConfirmDialog(null, GuiUtils.getStringLocalized("doYouWantToDeleteClips"), GuiUtils.getStringLocalized("confirmDeleteClips"),
