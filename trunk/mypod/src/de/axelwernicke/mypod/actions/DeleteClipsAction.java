...
/**
 * Delete Clips Action class. This action removes a clip from myPod and deletes
 * the media file
 */
public class DeleteClipsAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            // ClipsTableModel model =
            // (ClipsTableModel)clipsTableView.getModel(); TODO: cleanup
            ...
            if (oids.size() > 0) {
                int result = JOptionPane.showConfirmDialog(null, GuiUtils.getStringLocalized("doYouWantToDeleteClips"), GuiUtils
                        .getStringLocalized("confirmDeleteClips"), JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
