    ...
    public void actionPerformed(ActionEvent event) {
        ...
        try {
            ...
            do {
                ...
                if (!iPodFound) {
                    // ask user to retry
                    Object[] options = { GuiUtils.getStringLocalized("retry"), GuiUtils.getStringLocalized("abort") };
                    result = JOptionPane.showOptionDialog(null, GuiUtils.getStringLocalized("makeIPodAvailableAsDrive"), GuiUtils
                            .getStringLocalized("iPodNotAvailable"), JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options,
                            options[0]);
                }
            ...
            if (iPodFound) {
                ...
                int confirmation = JOptionPane.showConfirmDialog(null, GuiUtils
                        .getStringLocalized("doYouReallyWantToDeleteAllSongsAndPlaylistsFromYourIPod?"), GuiUtils
                        .getStringLocalized("confirmDeleteAction"), JOptionPane.YES_NO_OPTION);
