...
/**
 * Scan Action class. <br>
 * Action to scan media files and extract lots of information. <br>
...
public class ScanAction extends AbstractAction {
    ...
    /**
     * executes the ScanAction. <br>
     * open filechooser <br>
     * get choosen files and dirs <br>
     * scan them for meta data <br>
     * update all playlists and models
     * 
     * @param evt
     *            event
     */
                ...
                try {
                    ...
                    if (result == JFileChooser.APPROVE_OPTION) {
                        ...
                        if (files != null) {
                            ...
                            // update all autoplaylists if some clips were added
                            // or updated
                            if (cnt > 0) {
                                // do some gui stuff
                                ...
                                // tell the models about added items, this helps
                                // even for non auto-playlists
                                myPod.updateModels();
                            }
