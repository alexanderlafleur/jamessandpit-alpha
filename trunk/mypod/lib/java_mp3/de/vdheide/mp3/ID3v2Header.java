...
public class ID3v2Header
{
	...
	public ID3v2Header( byte version, byte revision,
											boolean unsynch, boolean extended_header, boolean experimental, int length )
	{
	 ...
	 */
	public ID3v2Header(InputStream in) throws ID3v2IllegalVersionException,
	 ...
	 * @exception IOException If an I/O error occurs
	 */
	public void readFromFile(InputStream in) throws ID3v2IllegalVersionException,
																									NoID3v2HeaderException, IOException
	{
		...
		version = head[3];
		revision = head[4];
		if ((version & 0xff) > (ID3v2.VERSION & 0xff) || (version == ID3v2.VERSION &&
