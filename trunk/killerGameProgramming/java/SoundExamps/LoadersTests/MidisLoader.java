...
public class MidisLoader implements MetaEventListener {
    ...
    /*
     * Set up the MIDI sequencer, and the sequencer's meta-event listener. No synthesizer is used here.
     */
    {
        try {
    ...
    /*
     * The format of the input lines are: <name> <fnm> // a single sound file and blank lines and comment lines.
     */
    {
