...
public class LoadersTests extends JFrame implements ActionListener, ItemListener, SoundsWatcher {
    ...
    /*
     * Triggered by a "Play", "Loop", "Pause/Resume", "Stop" button press. The relevant method in MidisLoader is called. A lot of effort is spent on
     * disabling/enabling the right buttons.
     */
    {
        ...
        if (e.getSource() == playJbut) { // "Play" pressed
            ...
            midisLoader.play(songName, true); // play the sequence, with
            // looping
            playJbut.setEnabled(false);
            ...
            loopJbut.setBackground(background); // syop highlighting the loop
            // button
    ...
    /*
     * The right hand side is a series of 4 checkboxes for looping the clips. The left hand side is a series of buttons for playing, pausing/resuming,
     * stopping, looping the chosen midi sequence. A list of the sequences is given in a combo box.
     */
    {
        ...
        p2.add(playJbut);
        pauseJbut = new JButton("Resume"); // this text helps sets the max
        // dimensions
