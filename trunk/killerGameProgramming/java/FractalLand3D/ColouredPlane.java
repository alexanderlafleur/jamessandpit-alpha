...
public class ColouredPlane extends Shape3D {
    ...
    public ColouredPlane(Point3d p1, Point3d p2, Point3d p3, Point3d p4, Vector3f normVec, Color3f col) {
        createGeometry(p1, p2, p3, p4, normVec);
        createAppearance(col);
    } // end of ColouredPlane()

    private void createGeometry(Point3d p1, Point3d p2, Point3d p3, Point3d p4, Vector3f normVec) {
