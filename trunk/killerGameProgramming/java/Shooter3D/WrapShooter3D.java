...
// Holds the 3D canvas where the loaded image is displayed
{
    ...
    /*
     * The gun is a cylinder with a cone on top which can rotate. 'Inside' the cone is a small red cylinder, which is animated to become a 'laser
     * beam'. When the user clicks on the checkboard, the beam is fired at the location of the click. When it hits the target, an explosion occurs.
    ...
    { // starting vector for the gun cone and beam
        ...
        ShootingBehaviour shootBeh = new ShootingBehaviour(canvas3D, sceneBG, bounds, new Point3d(0, 2, 0), expl, laser, gun);
