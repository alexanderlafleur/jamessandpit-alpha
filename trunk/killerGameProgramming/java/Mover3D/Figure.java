...
public class Figure {
    ...
    /*
     * A limb requires a limb number, its start and end joints, an axis of orientation and angle to that axis, and lathe shape coordinates and texture.
     * 
     * If the limb will be moveable (i.e. a MoveableLimb or MoveableEllipticLimb object), then it also requires a name and x-, y-, z- ranges to restrict its movements.
     */
    {
        // the figure's bottom
        ...
        // the figure's chest: moveable so has a name ("chest") and rotation
        // ranges
        double xsIn2[] = { -0.001, -0.2, 0.36, 0.001 };
        double ysIn2[] = { 0, 0, 0.50, 0.68 };
        MoveableEllipticLimb limb2 = new MoveableEllipticLimb("chest", 2, "j1", "j2", Z_AXIS, 0, xsIn2, ysIn2, "camoflage.jpg");
        limb2.setRanges(0, 120, -60, 60, -40, 40);
        // x range: 0 to 120; y range: -60 to 60; z range: -40 to 40

        this.limbs.add(limb1);
        this.limbs.add(limb2);

        this.limbNames.put("chest", new Integer(2));
    ...
    private void buildHead() {
        ...
        MoveableLimb limb4 = new MoveableLimb("head", 4, "j3", "j4", Z_AXIS, 0, xsIn4, ysIn4, "head.jpg");
        limb4.setRanges(-40, 40, -40, 40, -30, 30);

        this.limbs.add(limb3);
        this.limbs.add(limb4);

        this.limbNames.put("head", new Integer(4));
    } // end of buildHead()

    private void buildRightArm() {
        /*
         * An invisible limb connecting the neck and upper right arm. It is invisible since no lathe shape coords or texture are supplied. However, it does have a length (0.35).
         */
        ...
        MoveableLimb limb6 = new MoveableLimb("urArm", 6, "j5", "j6", Z_AXIS, 80, xsIn6, ysIn6, "rightarm.jpg");
        limb6.setRanges(-60, 180, -90, 90, -90, 30);

        // lower right arm
        double xsIn7[] = { 0, 0.08, 0.055, 0 };
        double ysIn7[] = { 0, 0.08, 0.38, 0.43 };
        MoveableLimb limb7 = new MoveableLimb("lrArm", 7, "j6", "j7", Z_AXIS, 5, xsIn7, ysIn7, "skin.jpg");
        limb7.setRanges(0, 150, -90, 90, -90, 90);

        // right hand
        double xsIn8[] = { 0, 0.06, 0.04, 0 };
        double ysIn8[] = { 0, 0.07, 0.16, 0.2 };
        MoveableEllipticLimb limb8 = new MoveableEllipticLimb("rHand", 8, "j7", "j8", Z_AXIS, 0, xsIn8, ysIn8, "skin.jpg");
        limb8.setRanges(-50, 50, -40, 90, -40, 40);

        this.limbs.add(limb5);
        this.limbs.add(limb6);
        this.limbs.add(limb7);
        this.limbs.add(limb8);

        this.limbNames.put("urArm", new Integer(6));
        this.limbNames.put("lrArm", new Integer(7));
        this.limbNames.put("rHand", new Integer(8));
    ...
    // very similar to buildRightArm()
    {
        ...
        MoveableLimb limb10 = new MoveableLimb("ulArm", 10, "j9", "j10", Z_AXIS, -80, xsIn10, ysIn10, "leftarm.jpg");
        limb10.setRanges(-60, 180, -90, 90, -30, 90);

        // lower left arm
        double xsIn11[] = { 0, 0.08, 0.055, 0 };
        double ysIn11[] = { 0, 0.08, 0.38, 0.43 };
        MoveableLimb limb11 = new MoveableLimb("llArm", 11, "j10", "j11", Z_AXIS, -5, xsIn11, ysIn11, "skin.jpg");
        limb11.setRanges(0, 150, -90, 90, -90, 90);

        // left hand
        double xsIn12[] = { 0, 0.06, 0.04, 0 };
        double ysIn12[] = { 0, 0.07, 0.16, 0.2 };
        MoveableEllipticLimb limb12 = new MoveableEllipticLimb("lHand", 12, "j11", "j12", Z_AXIS, 0, xsIn12, ysIn12, "skin.jpg");
        limb12.setRanges(-50, 50, -90, 40, -40, 40);

        this.limbs.add(limb9);
        this.limbs.add(limb10);
        this.limbs.add(limb11);
        this.limbs.add(limb12);

        this.limbNames.put("ulArm", new Integer(10));
        this.limbNames.put("llArm", new Integer(11));
        this.limbNames.put("lHand", new Integer(12));
    } // end of buildLeftArm()
    ...
    private void buildRightLeg() {
        ...
        MoveableLimb limb14 = new MoveableLimb("urLeg", 14, "j13", "j14", Z_AXIS, 130, xsIn14, ysIn14, "denim.jpg");
        limb14.setRanges(-45, 80, -20, 20, -45, 30);

        // lower right leg
        double xsIn15[] = { 0, 0.10, 0.06, 0 };
        double ysIn15[] = { 0, 0.15, 0.62, 0.7 };
        MoveableLimb limb15 = new MoveableLimb("lrLeg", 15, "j14", "j15", Z_AXIS, 0, xsIn15, ysIn15, "lowDenim.jpg");
        ...
        MoveableEllipticLimb limb17 = new MoveableEllipticLimb("rFoot", 17, "j16", "j17", X_AXIS, 90, xsIn17, ysIn17, "shoes.jpg");
        limb17.setRanges(-90, 0, 0, 0, -30, 30);

        this.limbs.add(limb13);
        this.limbs.add(limb14);
        this.limbs.add(limb15);
        this.limbs.add(limb16);
        this.limbs.add(limb17);

        this.limbNames.put("urLeg", new Integer(14));
        this.limbNames.put("lrLeg", new Integer(15));
        this.limbNames.put("rFoot", new Integer(17));
    ...
    // very similar to buildRightLeg()
    {
        ...
        MoveableLimb limb19 = new MoveableLimb("ulLeg", 19, "j18", "j19", Z_AXIS, -130, xsIn19, ysIn19, "denim.jpg");
        limb19.setRanges(-45, 80, -20, 20, -30, 45);

        // lower left leg
        double xsIn20[] = { 0, 0.10, 0.06, 0 };
        double ysIn20[] = { 0, 0.15, 0.62, 0.7 };
        MoveableLimb limb20 = new MoveableLimb("llLeg", 20, "j19", "j20", Z_AXIS, 0, xsIn20, ysIn20, "lowDenim.jpg");
        ...
        MoveableEllipticLimb limb22 = new MoveableEllipticLimb("lFoot", 22, "j21", "j22", X_AXIS, 90, xsIn22, ysIn22, "shoes.jpg");
        limb22.setRanges(-90, 0, 0, 0, -30, 30);

        this.limbs.add(limb18);
        this.limbs.add(limb19);
        this.limbs.add(limb20);
        this.limbs.add(limb21);
        this.limbs.add(limb22);

        this.limbNames.put("ulLeg", new Integer(19));
        this.limbNames.put("llLeg", new Integer(20));
        this.limbNames.put("lFoot", new Integer(22));
    } // end of buildLeftLeg()
     ...
     */
    {
        ...
        int i = 0;
        Iterator it = this.limbNames.keySet().iterator();
        while (it.hasNext()) {
            String lNm = (String) it.next();
            System.out.print("(" + lNm + " = " + this.limbNames.get(lNm) + ") ");
            i++;
     ...
     * 
     * offsetTG is connected to figureTG; it specifies the distance from the floor to the first joint and limb.
     * 
     ...
     */
    {
        ...
        /*
         * joints will contain (jointName, TG) pairs. Each TG is the position of the joint in the scene.
         * 
         * A limb connected to a joint is placed in the scene by using the TG associated with that joint.
         */

        this.figureTG = new TransformGroup();
        this.figureTG.setCapability(TransformGroup.ALLOW_TRANSFORM_READ);
        this.figureTG.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE); // can
        // alter
        ...
        for (int i = 0; i < this.limbs.size(); i++) {
            li = (Limb) this.limbs.get(i);
            li.growLimb(joints);
        }

        this.figureTG.addChild(offsetTG);
    } // end of buildFigureGraph()

    public TransformGroup getFigureTG() {
        return this.figureTG;
    }
    ...
    // Is no a limb number?
    {
        if (this.limbNames.containsValue(new Integer(no))) {
            return no;
        } else {
    ...
    {
        Integer iNo = (Integer) this.limbNames.get(name);
        if (iNo == null) {
            return -1;
        } else {
            return iNo.intValue();
     ...
     */
    {
        Limb li = (Limb) this.limbs.get(limbNo - 1); // assume limbNo input is
        // correct
    ...
    /*
     * Move the figure forwards, backwards, left, right, up, or down. doMove() can be called from LocationBeh or CommandsPanel.
     */
    {
        if (dir == FWD) {
            doMoveVec(fwdVec);
    ...
    {
        this.figureTG.getTransform(this.t3d);
        this.toMove.setTranslation(theMove); // overwrite previous trans
        this.t3d.mul(this.toMove);
        this.figureTG.setTransform(this.t3d);
    } // end of doMoveVec()

    public void doRotateY(int rotDir)
    /*
     * Rotate the figure clockwise ot counter-clockwise around the y-axis. doRotateY() can be called from LocationBeh or CommandsPanel.
     */
    {
        if (rotDir == CLOCK) {
