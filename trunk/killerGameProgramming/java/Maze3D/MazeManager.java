...
public class MazeManager {
    ...
    /*
     * The coords are maze[Z]{X] i.e. x-coords along row, z-coords running down Remember that the maze plan's y-coords have been mapped to 3D scene
     * z-coords.
     */
    ...
    /*
     * Create a BranchGroup and BufferedImage to represent the maze. The maze plan array will contain spaces, a single 's' (starting point), and many
     * 'c's and 'b's (cylinders, blocks).
     */
    {
        System.out.println("Building maze representations... please wait");
        char ch;
        Graphics g = mazeImg.createGraphics();
