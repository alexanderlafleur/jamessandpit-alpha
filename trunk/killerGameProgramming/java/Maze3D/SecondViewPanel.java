...
public class SecondViewPanel extends JPanel {
    ...
    /*
     * Create the TG for the camera. Stand in the same place as the main camera, but face backwards. We know that 'front' is facing in the positive z
     * direction. So back should be pointing in the negative z direction.
     */
    {
