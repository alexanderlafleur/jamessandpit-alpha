...
public class PropManager {
    ...
    /*
     * Obtain coords info from the coordinates file for fnm. The coords file has the format: <3D object fnm> [-p px py pz] [-r sequence of numbers]
     * [-s scale]
     */
    {
    ...
    /*
     * The 3D object file is loaded using a Portfolio loader. The loaded object has 4 transform groups above it -- objBoundsTG is for adjusting the
     * object's bounded sphere so it is centered at (0,0,0) and has unit radius. The other TGs are for doing separate moves, rotations, and scaling of
     * the object. moveTG-->rotTG-->scaleTG-->objBoundsTG-->object
     */
    {
