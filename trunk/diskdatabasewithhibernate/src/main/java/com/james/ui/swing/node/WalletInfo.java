...
public class WalletInfo extends BaseInfo {
    ...
    private void createFields(WalletDTO wallet) {
        getFields().put(FIELD_DESCRIPTION, new FormField(FIELD_DESCRIPTION, wallet.getDescription()));
    }
    ...
    public List loadChildren() {
        ...
        for (Iterator i = disks.iterator(); i.hasNext();) {
            ...
            DefaultMutableTreeNode node = new DefaultMutableTreeNode(new DiskInfo(diskDTO.getId(), diskDTO.getLabel(), diskDTO, getHelper()));
