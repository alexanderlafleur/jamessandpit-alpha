...
public class MP3Info extends BaseInfo {
	...
	private void createFields(MP3DTO mp3) {
		...
		fields.put(FIELD_COMMENT,
				new FormField(FIELD_COMMENT, mp3.getComment()));
		...
		fields.put(FIELD_BITRATE, new FormField(FIELD_BITRATE, String
				.valueOf(mp3.getBitrate())));
		fields.put(FIELD_LENGTH, new FormField(FIELD_LENGTH, String.valueOf(mp3
				.getLength())));
		fields.put(FIELD_SIZE, new FormField(FIELD_SIZE, String.valueOf(mp3
				.getSize())));
		fields.put(FIELD_YEAR, new FormField(FIELD_YEAR, String.valueOf(mp3
				.getYear())));
