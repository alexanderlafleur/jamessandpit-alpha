...
/**
 * Cellrenderer for the list of playlist. Icons for filter and iPod sync are added to the name of the playlist.
 * 
...
class PlaylistListViewCellRenderer extends javax.swing.JLabel implements javax.swing.ListCellRenderer {
    ...
    /**
     * Here all the work is done. The status of the playlist is determined and the correct icon is added to the label.
     * 
     * @param list
     *            list object
     * @param value
     *            Playlist object
     * @param index
     *            index of value in the playlist
     * @param isSelected
