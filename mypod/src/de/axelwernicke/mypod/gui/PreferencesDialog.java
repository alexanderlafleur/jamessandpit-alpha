...
public class PreferencesDialog extends javax.swing.JDialog {
    ...
    // Logger.getLogger("de.axelwernicke.mypod.gui.PreferencesDialog" );
    private java.awt.Frame parent;

    private boolean confirmed;

    private java.util.Hashtable lookAndFeelInfo;

    /**
     * Creates new form PreferencesDialog.
     * 
     * @param _parent
     *            frame the dialog window is attached to
     * @param modal
    ...
    private void initComponents()// GEN-BEGIN:initComponents
    {
        ...
        ipodPathTextField.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        externalPlayerPathTextField.setHorizontalAlignment(SwingConstants.LEFT);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.gridwidth = 2;
    ...
    {// GEN-HEADEREND:event_lfComboBoxPopupMenuWillBecomeInvisible
        GuiUtils.setLookAndFeel((String) this.lookAndFeelInfo.get(this.lfComboBox.getSelectedItem()), parent);
    ...
    private void initLookAndFeelComboBox() {
        ...
        for (Object element : keys) {
            this.lfComboBox.addItem(element);
        }
    }
    ...
    void setPreferences(Preferences prefs) {
        ...
        String name = null;
        String key = null;
        Enumeration iter = this.lookAndFeelInfo.keys();
        while (name == null && iter.hasMoreElements()) {
            key = (String) iter.nextElement();
            if (((String) this.lookAndFeelInfo.get(key)).equals(prefs.getLookAndFeelName())) {
                name = key;
            }
        }
    ...
    Preferences getPrefs() {
        ...
        prefs.setLookAndFeelName((String) this.lookAndFeelInfo.get(this.lfComboBox.getSelectedItem()));
