...
/**
 * This is the main class of myPod. It contains all the code for starting and shutting down myPod, as well as the gui logic (actions etc.). It's kind of glue between application
 * logic and gui.
 * 
...
public class myPod {
    ...
    /**
     * myPods main class - never call this method directly. <BR>- show splash screen <BR>- check jvm version <BR>- create backend object <BR>- create frontend <BR>- update all
     * auto playlists <BR>- hide splas screen <BR>- show frontend ( main window )
     * 
     * @param args
    ...
    public static void setClipsTableColumnListener(final ListView clipsTableView) {
        MouseAdapter listMouseListener = new MouseAdapter() {
            /**
             * Handles mouse clicks to the table header in a list view. -> Changes the sorting of the table
             */
            @Override
