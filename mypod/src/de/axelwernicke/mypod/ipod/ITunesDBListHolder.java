...
/**
 * A ListHolder object stores the informations from the 'mhsd' tag. It has references to the lists contained.
 * 
 * </PRE>
 * 
 * mhsd:<br>
 ...
 * @author axelwe
 */
public class ITunesDBListHolder {
    /** jdk1.4 logger */
    ...
    public String toString() {
        return new StringBuffer("[tag size] ").append(tagSize).append('\t').append("[recordSize] ").append(recordSize).append('\t').append("[listType] ").append(listType)
                .toString();
    }
