            ...
            public Object construct() {
                ...
                try {
                    ...
                    if (missingClips != null && !missingClips.isEmpty()) {
                        ...
                        int result = JOptionPane.showConfirmDialog(null, GuiUtils.getStringLocalized("missingMediaFilesFound1") + " " + missingClips.size() + " "
                                + GuiUtils.getStringLocalized("missingMediaFilesFound2") + '\n' + GuiUtils.getStringLocalized("doYouWantToRemoveClips"), GuiUtils
