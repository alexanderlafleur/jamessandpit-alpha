...
/**
 * Reorganize Clips Action class <br>
 * Action to change directory structure and filenames according to some meta data of the files. <br>
 * type: asynchroneously / blocking
 * 
...
public class ReorganizeClipsAction extends AbstractAction {
    ...
    /**
     * executes the ReorganizeClipsAction. <br>
     * open the action preferences dialog <br>
     * reorganize clips
     * 
     * @param evt
     *            event
            ...
            public Object construct() {
                ...
                try {
                    ...
                    if (prefsDialog.isConfirmed()) {
                        ...
                        // reorganize clips
                        myPod.getBackend().reorganizeClips(progressDialog, prefsDialog.baseDirTextField.getText(), prefsDialog.dirStructComboBox.getSelectedIndex(),
                                prefsDialog.filenameStructComboBox.getSelectedIndex(), prefsDialog.isRemoveEmptyDirectories());
                    }
                } catch (Exception e) {
