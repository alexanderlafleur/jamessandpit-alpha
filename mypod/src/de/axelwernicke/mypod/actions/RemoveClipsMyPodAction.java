...
/**
 * Delete Clips Action class. This action removes aclip from the data pool and all playlists
 */
public class RemoveClipsMyPodAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            if (oids.size() > 0) {
                int result = JOptionPane.showConfirmDialog(null, GuiUtils.getStringLocalized("doYouWantToRemoveClips"), GuiUtils.getStringLocalized("confirmRemoveClips"),
