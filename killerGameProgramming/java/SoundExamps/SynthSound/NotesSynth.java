...
public class NotesSynth {
    ...
    // create a SourceDataLine for outputing the generated notes
    {
        ...
        /*
         * SAMPLE_RATE // samples/sec 16 // sample size in bits, values can be -2^15 -- 2^15-1 2 // no. of channels, stereo here 4 // frame size in bytes (2 bytes/sample * 2
         * channels) SAMPLE_RATE // same as frames/sec false // little endian
         */
    ...
    /*
     * We generate a single sine wave of the required amplitude and frequency, equivalent to a single note.
     * 
     * The pitch of the sound (how high the note is) depends on the frequency of the wave. The higher the frequency, the higher the pitch.
     * 
