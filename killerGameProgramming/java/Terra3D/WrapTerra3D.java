...
// Holds the 3D canvas where the loaded image is displayed
{
    ...
    /*
     * Adjust the clip distances and set up the KeyBehaviour. The behaviour initialises the viewpoint at the origin on the XZ plane. Also turn on
     * depth-sorting to deal with all the transparent GIFs used for the trees.
     */
    {
