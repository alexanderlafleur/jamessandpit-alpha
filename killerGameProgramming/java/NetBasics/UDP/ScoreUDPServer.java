     ...
     */
    {
        ...
        try {
            while (true) {
                ...
                this.serverSock.receive(receivePacket);

                processClient(receivePacket);

                this.hs.saveScores(); // backup high scores after each package has
                // finished
            }
