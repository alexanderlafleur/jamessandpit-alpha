...
public class AlienAStarSprite extends AlienSprite {
    ...
    /*
     * Derived from pseudo-code in: "The Basics of A* for Path Planning", Bryan Stout In 'Game Programming Gems', Mike DeLoura (ed.) Charles River
     * Media, 2000, part 3.3, pp. 254-263
     */
    {
        double newCost;
