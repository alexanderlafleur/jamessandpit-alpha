...
// Holds the 3D canvas where the loaded image is displayed
{
    ...
    /*
     * The alien is a hand. It's position is updated periodically by calls from a TimeBehavior object. The alien's behaviour is to try to catch the
     * TourSprite.
     */
    {
    ...
    /*
     * The TourSprite is a robot. The sprite and its control behaviour are created at he same time. The TouristControls object affects the view point,
     * so its TG is passed to it.
     */
    {
