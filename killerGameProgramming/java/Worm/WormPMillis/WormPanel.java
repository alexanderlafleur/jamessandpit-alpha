...
public class WormPanel extends JPanel implements Runnable {
     ...
     */
    {
        ...
        if (this.statsInterval >= MAX_STATS_INTERVAL) { // record stats every
            ...
            this.timeSpentInGame = (int) ((timeNow - this.gameStartTime) / 1000L); // ms
            // -->
            // secs
            ...
            if (this.totalElapsedTime > 0) {
                actualFPS = (((double) this.frameCount / this.totalElapsedTime) * 1000L);
                actualUPS = (((double) (this.frameCount + this.totalFramesSkipped) / this.totalElapsedTime) * 1000L);
            }
            ...
            /*
             * System.out.println(timedf.format( (double) statsInterval/1000L) + " " + timedf.format((double) realElapsedTime/1000L) + "s " + df.format(timingError) + "% " +
